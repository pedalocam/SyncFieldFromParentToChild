    ...
    return {
      ...
      onSaved: async (args: any) => {
        ...
        const workItems: { [key: number]: WorkItem } = (await clt.getWorkItems(
          [childId, parentId],
          undefined,
          ['System.TeamProject', 'System.AreaPath', 'System.IterationPath', 'System.Tags', 'Custom.COST01code', 'System.Parent']
        )).reduce(
        ...
        if (childWi.fields['System.TeamProject'] === parentWi.fields['System.TeamProject']) {
          ...
          if (settings.iteration) {
            payload.push({
              op: 'add',
              path: '/fields/Custom.COST01code',
              value: parentWi.fields['Custom.COST01code'],
            })
          }
